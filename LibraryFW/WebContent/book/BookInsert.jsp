...
<div class="header">書籍情報登録</div>

<form method="post" action="<%=request.getContextPath()%>/LibraryServlet">
<input type="hidden" name="viewId" value="BookInsert">
...
<tbody>
   ...
   <tr>
     <td><label for="user">所有者のID</label></td>
     <td><input type="text" id="userId" name="userId" maxlength=10 pattern="^[0-9A-Za-z]{1,10}" title="10桁以下の半角英数"></td>
